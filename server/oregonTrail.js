...
app.use(express.static('client/public'));
		...
		app.get('/setup', function(req, res){
			res.sendFile('aboutTheTrail.html', {root: './client/views'});
			});
		...
		app.route('/api/setup/leader').post(setupController.saveWagonLeader);
		...
		app.route('/api/game').get(gameController.getGameData);
		app.route('/api/setupStartMonth').get(setupController.setStartMonth);
		app.route('/api/setupPace').get(setupController.setInitialPace);
		app.route('/api/changePace').post(gameController.changePace);
		app.route('/api/updateGame').get(gameController.updateGame);
		app.route('/api/resetGame').get(gameController.resetGame);
